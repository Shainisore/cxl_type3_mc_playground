...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "emif_cal_one_ch.emif_cal_one_ch"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/research/quartus/v24.1/quartus/"
}
...
append ELAB_OPTIONS [subst [emif_cal_one_ch::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [emif_cal_one_ch::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set normalized_src [emif_cal_one_ch::normalize_path "$file"]
  set normalized_dest [emif_cal_one_ch::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [emif_cal_one_ch::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [emif_cal_one_ch::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [emif_cal_one_ch::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
