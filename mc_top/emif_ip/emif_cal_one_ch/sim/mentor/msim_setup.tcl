...
alias com {
  ...
  set common_design_files [dict values [emif_cal_one_ch::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [emif_cal_one_ch::get_design_files "$QSYS_SIMDIR"]]
