...
# ACDS 24.1 115 linux 2024.10.02.15:52:41
...
# ----------------------------------------
# If emif_cal_one_ch is one of several IP cores in your
...
TOP_LEVEL_NAME="emif_cal_one_ch.emif_cal_one_ch"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/research/quartus/v24.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [emif_cal_one_ch::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [emif_cal_one_ch::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [emif_cal_one_ch::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [emif_cal_one_ch::get_design_libraries]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [emif_cal_one_ch::get_memory_files "$QSYS_SIMDIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctfb_hssi_atoms.sv"            -work tennm_hssi_f1_ver
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctfb_hssi_atoms_ncrypt.sv"     -work tennm_hssi_f1_ver
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctfb_hssi_atoms2_ncrypt.sv"    -work tennm_hssi_f1_ver
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctr_hssi_atoms.sv"             -work tennm_hssi_r1_ver
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctr_hssi_atoms_ncrypt.sv"      -work tennm_hssi_r1_ver
  xmvlog -sv +define+rnrb_one_lib_CXL_TOP_OFF $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctrb_hssi_atoms_ncrypt.sv"     -work tennm_hssi_r1_ver
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [emif_cal_one_ch::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [emif_cal_one_ch::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [emif_cal_one_ch::get_dpi_libraries "$QSYS_SIMDIR"]]
